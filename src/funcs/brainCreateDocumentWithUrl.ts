 ...
 */
export async function brainCreateDocumentWithUrl(
  client: AcpCore,
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.CreateDocumentWithUrlRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/brain/{brain_id}/documents/url")(pathParams);
