...
export interface Env {
  ACP_USERNAME?: string | undefined;
  ACP_PASSWORD?: string | undefined;

  ACP_DEBUG?: boolean | undefined;
}

export const envSchema: z.ZodType<Env, z.ZodTypeDef, unknown> = z.object({
  ACP_USERNAME: z.string(),
  ACP_PASSWORD: z.string(),

  ACP_DEBUG: z.coerce.boolean(),
})
  .partial();
