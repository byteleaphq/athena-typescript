...
/** @internal */
export const ActiveFeatures$inboundSchema: z.ZodType<
  ActiveFeatures,
  z.ZodTypeDef,
  unknown
> = z.object({});
...
export const Brain$inboundSchema: z.ZodType<Brain, z.ZodTypeDef, unknown> = z
  .object({
    active_features: z.nullable(z.lazy(() => ActiveFeatures$inboundSchema))
      .optional(),
    ...
    metadata_schema: z.nullable(z.lazy(() => MetadataSchema$inboundSchema))
      .optional(),
...
/** @internal */
export const Brain$outboundSchema: z.ZodType<
  Brain$Outbound,
  z.ZodTypeDef,
  Brain
> = z.object({
  activeFeatures: z.nullable(z.lazy(() => ActiveFeatures$outboundSchema))
    .optional(),
  ...
  metadataSchema: z.nullable(z.lazy(() => MetadataSchema$outboundSchema))
    .optional(),
