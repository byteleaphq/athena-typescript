...
export const ActiveReadingModel = {
  Gpt35Turbo: "gpt-3.5-turbo",
  Claude3Haiku: "claude-3-haiku",
  Mixtral: "mixtral",
} as const;
export type ActiveReadingModel = ClosedEnum<typeof ActiveReadingModel>;

export const FinalReviewModel = {
  Gpt35Turbo: "gpt-3.5-turbo",
  Gpt4: "gpt-4",
...
export type FinalReviewModel = ClosedEnum<typeof FinalReviewModel>;
...
/** @internal */
export const ActiveReadingModel$inboundSchema: z.ZodNativeEnum<
  typeof ActiveReadingModel
> = z.nativeEnum(ActiveReadingModel);

/** @internal */
export const ActiveReadingModel$outboundSchema: z.ZodNativeEnum<
  typeof ActiveReadingModel
...
/** @internal */
export const FinalReviewModel$inboundSchema: z.ZodNativeEnum<
  typeof FinalReviewModel
> = z.nativeEnum(FinalReviewModel);

/** @internal */
export const FinalReviewModel$outboundSchema: z.ZodNativeEnum<
  typeof FinalReviewModel
